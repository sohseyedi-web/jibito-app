...
<template>
  <AppForm @submit="onSubmit" class="text-white space-y-3 lg:w-[75%] w-[95%] mx-auto flex items-center justify-center h-screen">
    <h2 class="text-xl font-semibold">افزایش موجودی</h2>
    <AppInput
